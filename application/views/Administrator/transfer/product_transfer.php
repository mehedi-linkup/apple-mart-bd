                            ...
                            <div class="col-md-9">
                                <form v-on:submit.prevent="addToCart()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" :disabled="selectedProduct != null && selectedProduct.is_serial == 1 ? true : false"  class="form-control" v-model="quantity" ref="quantity"  required v-on:input="productTotal">
                                        </div>
                                    </div>
                                    <div class="form-group">
