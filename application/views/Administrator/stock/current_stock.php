				...
				<table class="table table-bordered" v-if="searchType == 'current'" style="display:none" v-bind:style="{display: searchType == 'current' ? '' : 'none'}">
					...
					<tbody>
						<tr v-for="product in stock">
							...
							<td>
								<button type="button" v-if="product.is_serial == 1" class="button edit" @click="viewSerial(product.product_id)"><i class="fa fa-eye"></i></button>
							</td>
						</tr>
					</tbody>
					<tfoot>
				...
				<table class="table table-bordered" 
					...
					<tbody>
						<tr v-for="product in stock">
							...
							<td>{{ product.stock_value | decimal }}</td>
							<td>
								<button type="button" v-if="product.is_serial == 1" class="button edit" @click="viewSerial(product.Product_SlNo)"><i class="fa fa-eye"></i></button>
							</td>
						</tr>
					</tbody>
					<tfoot>
